  ...
  <img src={image} style={{ objectFit: 'cover' }} className="rounded-lg" alt="" />
    ...
    <div className="px-5 pb-5 shadow-xl rounded-xl">
        ...
        <div className="flex justify-between items-center">
            ...
            <Link to={`/program/${_id}`} className="text-white bg-blue-500 hover:bg-blue-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Learn More</Link>
        </div>
    </div>
</div>
