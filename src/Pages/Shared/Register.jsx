  ...
  return (
    <div className="h-screen md:w-3/4 lg:w-2/4 mx-auto mt-28 text">
      <div className="text-center mb-16">
        <h2 className="text-5xl font-bold text-gray-700">Create A New Account</h2>
      </div>
      <form onSubmit={handleSignUp}>
        ...
        <button
          ...
          >
          <span class="w-full relative px-8 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 rounded-md group-hover:bg-opacity-0">
